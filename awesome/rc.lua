...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/alfie/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ },                   "F12",   function () awful.util.spawn("shutdown-dialog") end),
...
awful.rules.rules = {
    ...
    { rule = { class = "Plasma-desktop" },
      properties = { floating = true },
      callback = function(c)
          c:geometry( { width = 600 , height = 350 } )
      end,
    },
